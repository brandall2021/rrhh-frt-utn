...
import {
  employeeDocuments as initialEmployeeDocuments,
  paySlipsData as initialPaySlips,
  versionHistoryData as initialVersionHistory,
} from "../data";
...
export default function EmployeeProfileView({
  ...
  const [documents, setDocuments] = useState<DocumentRecord[]>(
    initialEmployeeDocuments[employee.id] || []
  );
  const [paySlips, setPaySlips] = useState<PaySlip[]>(initialPaySlips[employee.id] || []);
  const [versionHistory, setVersionHistory] = useState<VersionHistoryRecord[]>(
    initialVersionHistory[employee.id] || []
  );
